...
{{--    </div>--}}
{{--</div>--}}
<div class="border border-black flex flex-row justify-center items-center">
   <div class="border border-black">
       ...
       <form
           ...
           method="post"
           class="rounded-2xl p-5 lg:p-10 bg-white dark:bg-gray-600 w-full grid grid-cols-1 gap-y-1 h-auto lg:h-[624px] w-full lg:w-[510px] justify-between"
       >
...
{{--                       <p class="break-words">--}}
{{--                           A Edmond está comprometida em proteger e respeitar a sua privacidade e só utilizaremos as suas--}}
{{--                           informações pessoais para administrar a sua conta e para fornecer os produtos e serviços que--}}
{{--                           solicitar.--}}
{{--                           <br>--}}
{{--                       </p>--}}
{{--                   </label>--}}
...
{{--                        <a href="https://edmond.com.br/politica-aviso-de-privacidade-e-cookies-appsolar/"--}}
{{--                           target="_blank" class="text-primary">Aviso de Privacidade</a>--}}
{{--                        e--}}
{{--                        <a href="https://edmond.com.br/politica-termos-de-uso-appsolar/" target="_blank"--}}
{{--                           class="text-primary">Termos de Uso</a>.--}}
{{--                    </span>--}}
{{--                   </label>--}}
...
{{--                           ])--}}
{{--                       />--}}
{{--                       <span class="break-words w-72 lg:w-full">  Acesse as Condições Gerais de Venda e Compra na AppSolar, <a target="_blank" class="text-primary" href="#">clique aqui</a>.</span>--}}
{{--                   </label>--}}
{{--                   @error('policy_sale')--}}
{{--                   <small class="text-red-500">{{$message}}</small>--}}
{{--                   @enderror--}}
{{--               </div>--}}
           ...
           <div class="w-full flex items-center justify-center gap-x-5 py-2 mt-2 ">
               <button type="submit"
                       class="border-2 border-transparent px-8 py-4 font-semibold text-sm rounded-bl-full rounded-r-full bg-primary hover:scale-105 hover:shadow-lg hover:shadow-gray-500/40 ease-in-out active:shadow-md active:brightness-110 w-max text-primary_text flex justify-center items-center">
                   Cadastrar
               </button>
           </div>
...
{{--               <p class="text-gray-500"><a href="https://edmond.com.br/appsolar/" class="bg-red-500" target="_blank">Saiba mais</a></p>--}}
{{--           </div>--}}
