<div class="flex flex-col justify-center items-center mt-20">
    <div class=" w-[550px] p-4 flex flex-col">
        ...
        <form method="POST" wire:submit.prevent="login" class="flex flex-col gap-2">
            ...
            <div class="relative">
                <button type="submit"
                        class="bg-[#043873] w-full font-bold text-white rounded-[5px] py-2 transition-all duration-200
                    active:scale-[0.99]">Entrar
                </button>
                <div wire:loading wire:target="login" class="absolute top-0 left-0 w-full h-full z-10">
        ...
        <div class="flex flex-col gap-3 mt-5">
            <div class="flex flex-row justify-center text-[15px]">
                <p class="text-gray-700 font-medium ">
                    Ainda não possuí uma conta? <span class="text-[#0084ff] font-medium cursor-pointer hover:underline"
            ...
            <div class="mt-3">
                <p class="text-gray-700 font-medium text-[13.5px] text-center">
                    Utilizamos cookies para melhorar sua experiência em nossos serviços. Ao realizar seu login,
                    consideramos
                    que você aceita esta utilização. Para mais informações, acesse nossa <span
                        class="text-[#0084ff] hover:underline cursor-pointer">Política de Privacidade</span>.
                </p>
            </div>
        </div>
    </div>
