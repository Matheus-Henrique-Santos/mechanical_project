            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="#" class="flex ms-2 md:me-24">
                        ...
                        <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap text-white">Mechanical</span>
                    </a>
                </div>
    ...
    <aside id="logo-sidebar"
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-blue-black">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a class="flex items-center p-2 rounded-lg hover:bg-gray-400 cursor-pointer"
                       wire:click="logout">
                        <svg
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap text-white">Loggout</span>
                    </a>
                </li>
            </ul>
        </div>
